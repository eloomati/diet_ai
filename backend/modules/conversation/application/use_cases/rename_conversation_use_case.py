...
from backend.modules.conversation.application.dto.rename_conversation_dto import (
...
class RenameConversationUseCase:
    ...
    async def execute(self, command: RenameConversationCommand) -> GetConversationHistoryResult:
