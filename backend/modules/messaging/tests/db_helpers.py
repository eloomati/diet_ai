...
async def create_thread_directly(user_id: str, dietitian_id: str) -> str:
    """This etap's own tests need an existing thread without going through
    the real Kafka consumer (already covered by this stage's own live
    Docker verification) — same direct-DB-bootstrap spirit as
