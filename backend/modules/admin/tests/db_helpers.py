...
async def promote_role(user_id: str, role: Role) -> None:
    """No API path grants ADMIN/SUPER_ADMIN except the role-change endpoint
    itself (SUPER_ADMIN-only, chicken-and-egg for the first admin) — same
    direct-SQL bootstrap used since Etap 0's first SUPER_ADMIN."""
