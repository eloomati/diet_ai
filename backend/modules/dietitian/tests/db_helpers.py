...
async def promote_to_dietitian(user_id: str) -> None:
    """Etap 2 (admin approval) is what will normally grant `DIET_USER` — it
    doesn't exist yet, so tests for this stage promote directly instead."""
...
async def promote_to_dietitian_with_profile(
    user_id: str,
    experience: str = "5 years experience",
    diplomas: tuple[str, ...] = ("MSc Dietetics",),
    description: str = "Weight management specialist.",
) -> None:
