...
class RemoveDietitianProfilePhotoUseCase:
    def __init__(self, repository: DietitianProfileRepository) -> None:
        self._repository = repository

    async def execute(self, user_id: UUID, index: int) -> DietitianProfileResult:
        ...
        # remove_photo() raises InvalidDietitianProfileError for an out-of-range
        # index — mapped to 400 at the API layer, same as any other bad input.
        profile.remove_photo(index)
